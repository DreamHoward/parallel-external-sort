...
void MergesphaseParallel(int num_ways,int num_tempfile){
    long i;
...
int main(int argc,char* argv[]){
    const long int inputSize = 1024*100000;
    ...
    string inputfile = "input100MB.txt";
    ...
    gettimeofday(&start , NULL);
    //mergephase(num_ways, num_tempfile);
    MergesphaseParallel(num_ways, num_tempfile);
    gettimeofday (&end, NULL);
